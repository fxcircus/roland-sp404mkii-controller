...
4. **Pad grid** (MIDI Mode A) — bank A-J selector (ch1-10), 4×4 pads on notes 36-51 with velocity slider and note-off on release, plus an EXT SOURCE button (note 35) in toggle or gate mode.
...
12. **Verification checklist** — the two open hardware questions from the map's meta, each with a scripted Test button and a persisted pass/fail + notes field.
